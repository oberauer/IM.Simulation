...
for id = 1:E.nsubj
    ...
    CreateMapping(E.calibrateAmp==2);
        ...
        for trial = 1:(12*E.ntrials)
            ...
            if ModelContinuousReprod
                % pretend this is a continuous-reproduction test
                E.test = 1;
        ...
        for condition = 1:12
            ...
            if (ptype == 1)
                PC(id, ptype, cueingcond) = Pyes(id, ptype, cueingcond);
            else
                PC(id, ptype, cueingcond) = 1-Pyes(id, ptype, cueingcond);
            end
            RT(id, ptype, cueingcond) = mean(rt(:,condition))./1000;
