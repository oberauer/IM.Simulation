...
P.IOR = 0.7;           % inhibition of return in FX (0.3 works well except it messes up guided refreshing)
...
P.wnoise = 0.2; % 0.15;      % at at which noise variance added to W increases with time (in seconds) 
