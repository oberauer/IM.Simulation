...
for probed = 1:E.outsize
    [response(:,probed), rt(probed), Map, W, G, Focus, CWcolor, maxFX2, maxW2, maxFXprobe] = IMretrieve(Map, W, G, Focus, Afocus, probed, cueing, L, F, probestim, probeIdx, overTime);
    if probed == 1 && ~exist('maxW', 'var')
        maxW = maxW2;
        maxFX = maxFX2;
    end
end  % outpos
